                    ...
                    <div class="col-sm-6">
                        <div class="contactinfo">
                            <ul class="nav nav-pills">
                                ...
                                <li><a href="#"><i class="fa fa-envelope"></i> info@RK-Tech.com</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-6">
                ...
                <div class="row">
                    <div class="col-md-4 clearfix">
                        <div class="logo pull-left">
                            <a href="<?php echo base_url();?>"><img src="<?php echo base_url('assets/images/home/logo.png');?>" alt="logo" /></a>
                        </div>
                    </div>
                    ...
                    <div class="col-md-8 clearfix">
                        <div class="shop-menu clearfix pull-right">
                            <ul class="nav navbar-nav">
                                ...
                                <li><a href="<?php echo base_url('account');?>"><i class="fa fa-lock"></i> Login</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="row">
                    ...
                    <p class="pull-right">Designed by <span><a target="_blank" href="http://www.themeum.com">Themeum </a> </span> Develop by Kuntal Sarkar & Rahul Saha</p>
                </div>
            </div>
        </div>
